...
class AbstractTask(abc.ABC):
    ...
    def load_dataset(self, split: int):
        return datasets.load_dataset(self.name, self.config, split=split, script_version="2.0.0")
...
class Squad(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(self.name, split=split, script_version="2.0.0")
...
class DROP(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset("drop", split=split, script_version="2.0.0")
...
class PIQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('piqa', split=split, script_version="2.0.0")
...
class CommonsenseQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('commonsense_qa', split=split, script_version="2.0.0")
...
class MRPC(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'mrpc', split=split, script_version="2.0.0")
